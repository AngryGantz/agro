CKEDITOR.plugins.add( 'charcount',
{
   init : function( editor )
   {
      ...
      var defaultFormat = 'Введено символов: <span class="cke_charcount_count">%count%</span> из максимально возможных <span class="cke_charcount_limit">%limit%</span>';
      ...
      {   
         ...
         editor.on( 'themeSpace', function( event )
         {
            ...
            {
               event.data.html += '<div id="'+counterId(event.editor)+'" class="cke_charcount"' + ' title="' + CKEDITOR.tools.htmlEncode( 'Character Counter' ) + '"' + '>&nbsp;</div>';
            }
         }, editor, null, 100 );
